...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 13. Jul 2019 um 15:53
...
CREATE TABLE `media` (
  ...
  `type` enum('DVD','CD','BOOK') DEFAULT NULL,
...
INSERT INTO `media` (`ISBN`, `title`, `description`, `type`, `publish_date`, `availability`, `FK_publisher_ID`) VALUES
(1, 'Laleou', 'an awesome book', 'BOOK', '2019-01-01', 'available', 1),
(2, 'Nepumuk', 'best book brother', 'BOOK', '2019-07-01', 'reserved', 3),
(3, 'Sofa Sessel', 'nice book', 'BOOK', '2019-01-02', 'reserved', 2);
...
--
ALTER TABLE `betweenauthormedia`
  ADD CONSTRAINT `betweenauthormedia_ibfk_1` FOREIGN KEY (`FK_ISBN`) REFERENCES `media` (`ISBN`),
